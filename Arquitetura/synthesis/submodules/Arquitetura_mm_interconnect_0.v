...
module Arquitetura_mm_interconnect_0 (
		...
		output wire [1:0]  wrclk_s1_address,                               //                                 wrclk_s1.address
		output wire        wrclk_s1_write,                                 //                                         .write
		input  wire [31:0] wrclk_s1_readdata,                              //                                         .readdata
		output wire [31:0] wrclk_s1_writedata,                             //                                         .writedata
		output wire        wrclk_s1_chipselect,                            //                                         .chipselect
	...
	wire   [8:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> data_A_s1_agent:cp_channel
	...
	wire   [8:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> data_B_s1_agent:cp_channel
	...
	wire  [31:0] wrclk_s1_agent_m0_readdata;                                                         // wrclk_s1_translator:uav_readdata -> wrclk_s1_agent:m0_readdata
	wire         wrclk_s1_agent_m0_waitrequest;                                                      // wrclk_s1_translator:uav_waitrequest -> wrclk_s1_agent:m0_waitrequest
	wire         wrclk_s1_agent_m0_debugaccess;                                                      // wrclk_s1_agent:m0_debugaccess -> wrclk_s1_translator:uav_debugaccess
	wire  [16:0] wrclk_s1_agent_m0_address;                                                          // wrclk_s1_agent:m0_address -> wrclk_s1_translator:uav_address
	wire   [3:0] wrclk_s1_agent_m0_byteenable;                                                       // wrclk_s1_agent:m0_byteenable -> wrclk_s1_translator:uav_byteenable
	wire         wrclk_s1_agent_m0_read;                                                             // wrclk_s1_agent:m0_read -> wrclk_s1_translator:uav_read
	wire         wrclk_s1_agent_m0_readdatavalid;                                                    // wrclk_s1_translator:uav_readdatavalid -> wrclk_s1_agent:m0_readdatavalid
	wire         wrclk_s1_agent_m0_lock;                                                             // wrclk_s1_agent:m0_lock -> wrclk_s1_translator:uav_lock
	wire  [31:0] wrclk_s1_agent_m0_writedata;                                                        // wrclk_s1_agent:m0_writedata -> wrclk_s1_translator:uav_writedata
	wire         wrclk_s1_agent_m0_write;                                                            // wrclk_s1_agent:m0_write -> wrclk_s1_translator:uav_write
	wire   [2:0] wrclk_s1_agent_m0_burstcount;                                                       // wrclk_s1_agent:m0_burstcount -> wrclk_s1_translator:uav_burstcount
	wire         wrclk_s1_agent_rf_source_valid;                                                     // wrclk_s1_agent:rf_source_valid -> wrclk_s1_agent_rsp_fifo:in_valid
	wire  [95:0] wrclk_s1_agent_rf_source_data;                                                      // wrclk_s1_agent:rf_source_data -> wrclk_s1_agent_rsp_fifo:in_data
	wire         wrclk_s1_agent_rf_source_ready;                                                     // wrclk_s1_agent_rsp_fifo:in_ready -> wrclk_s1_agent:rf_source_ready
	wire         wrclk_s1_agent_rf_source_startofpacket;                                             // wrclk_s1_agent:rf_source_startofpacket -> wrclk_s1_agent_rsp_fifo:in_startofpacket
	wire         wrclk_s1_agent_rf_source_endofpacket;                                               // wrclk_s1_agent:rf_source_endofpacket -> wrclk_s1_agent_rsp_fifo:in_endofpacket
	wire         wrclk_s1_agent_rsp_fifo_out_valid;                                                  // wrclk_s1_agent_rsp_fifo:out_valid -> wrclk_s1_agent:rf_sink_valid
	wire  [95:0] wrclk_s1_agent_rsp_fifo_out_data;                                                   // wrclk_s1_agent_rsp_fifo:out_data -> wrclk_s1_agent:rf_sink_data
	wire         wrclk_s1_agent_rsp_fifo_out_ready;                                                  // wrclk_s1_agent:rf_sink_ready -> wrclk_s1_agent_rsp_fifo:out_ready
	wire         wrclk_s1_agent_rsp_fifo_out_startofpacket;                                          // wrclk_s1_agent_rsp_fifo:out_startofpacket -> wrclk_s1_agent:rf_sink_startofpacket
	wire         wrclk_s1_agent_rsp_fifo_out_endofpacket;                                            // wrclk_s1_agent_rsp_fifo:out_endofpacket -> wrclk_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> wrclk_s1_agent:cp_valid
	wire  [94:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> wrclk_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // wrclk_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> wrclk_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> wrclk_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> wrclk_s1_agent:cp_endofpacket
	...
	wire   [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> wrreg_s1_agent:cp_channel
	...
	wire   [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> wrfull_s1_agent:cp_channel
	...
	wire         wrclk_s1_agent_rp_valid;                                                            // wrclk_s1_agent:rp_valid -> router_008:sink_valid
	wire  [94:0] wrclk_s1_agent_rp_data;                                                             // wrclk_s1_agent:rp_data -> router_008:sink_data
	wire         wrclk_s1_agent_rp_ready;                                                            // router_008:sink_ready -> wrclk_s1_agent:rp_ready
	wire         wrclk_s1_agent_rp_startofpacket;                                                    // wrclk_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         wrclk_s1_agent_rp_endofpacket;                                                      // wrclk_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         wrclk_s1_agent_rdata_fifo_src_valid;                                                // wrclk_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] wrclk_s1_agent_rdata_fifo_src_data;                                                 // wrclk_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         wrclk_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_006:in_0_ready -> wrclk_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> wrclk_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> wrclk_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                  // wrclk_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> wrclk_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (wrclk_s1_agent_m0_address),                      // avalon_universal_slave_0.address
		.uav_burstcount         (wrclk_s1_agent_m0_burstcount),                   //                         .burstcount
		.uav_read               (wrclk_s1_agent_m0_read),                         //                         .read
		.uav_write              (wrclk_s1_agent_m0_write),                        //                         .write
		.uav_waitrequest        (wrclk_s1_agent_m0_waitrequest),                  //                         .waitrequest
		.uav_readdatavalid      (wrclk_s1_agent_m0_readdatavalid),                //                         .readdatavalid
		.uav_byteenable         (wrclk_s1_agent_m0_byteenable),                   //                         .byteenable
		.uav_readdata           (wrclk_s1_agent_m0_readdata),                     //                         .readdata
		.uav_writedata          (wrclk_s1_agent_m0_writedata),                    //                         .writedata
		.uav_lock               (wrclk_s1_agent_m0_lock),                         //                         .lock
		.uav_debugaccess        (wrclk_s1_agent_m0_debugaccess),                  //                         .debugaccess
		.av_address             (wrclk_s1_address),                               //      avalon_anti_slave_0.address
		.av_write               (wrclk_s1_write),                                 //                         .write
		.av_readdata            (wrclk_s1_readdata),                              //                         .readdata
		.av_writedata           (wrclk_s1_writedata),                             //                         .writedata
		.av_chipselect          (wrclk_s1_chipselect),                            //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (wrclk_s1_agent_m0_address),                      //              m0.address
		.m0_burstcount           (wrclk_s1_agent_m0_burstcount),                   //                .burstcount
		.m0_byteenable           (wrclk_s1_agent_m0_byteenable),                   //                .byteenable
		.m0_debugaccess          (wrclk_s1_agent_m0_debugaccess),                  //                .debugaccess
		.m0_lock                 (wrclk_s1_agent_m0_lock),                         //                .lock
		.m0_readdata             (wrclk_s1_agent_m0_readdata),                     //                .readdata
		.m0_readdatavalid        (wrclk_s1_agent_m0_readdatavalid),                //                .readdatavalid
		.m0_read                 (wrclk_s1_agent_m0_read),                         //                .read
		.m0_waitrequest          (wrclk_s1_agent_m0_waitrequest),                  //                .waitrequest
		.m0_writedata            (wrclk_s1_agent_m0_writedata),                    //                .writedata
		.m0_write                (wrclk_s1_agent_m0_write),                        //                .write
		.rp_endofpacket          (wrclk_s1_agent_rp_endofpacket),                  //              rp.endofpacket
		.rp_ready                (wrclk_s1_agent_rp_ready),                        //                .ready
		.rp_valid                (wrclk_s1_agent_rp_valid),                        //                .valid
		.rp_data                 (wrclk_s1_agent_rp_data),                         //                .data
		.rp_startofpacket        (wrclk_s1_agent_rp_startofpacket),                //                .startofpacket
		...
		.rf_sink_ready           (wrclk_s1_agent_rsp_fifo_out_ready),              //         rf_sink.ready
		.rf_sink_valid           (wrclk_s1_agent_rsp_fifo_out_valid),              //                .valid
		.rf_sink_startofpacket   (wrclk_s1_agent_rsp_fifo_out_startofpacket),      //                .startofpacket
		.rf_sink_endofpacket     (wrclk_s1_agent_rsp_fifo_out_endofpacket),        //                .endofpacket
		.rf_sink_data            (wrclk_s1_agent_rsp_fifo_out_data),               //                .data
		.rf_source_ready         (wrclk_s1_agent_rf_source_ready),                 //       rf_source.ready
		.rf_source_valid         (wrclk_s1_agent_rf_source_valid),                 //                .valid
		.rf_source_startofpacket (wrclk_s1_agent_rf_source_startofpacket),         //                .startofpacket
		.rf_source_endofpacket   (wrclk_s1_agent_rf_source_endofpacket),           //                .endofpacket
		.rf_source_data          (wrclk_s1_agent_rf_source_data),                  //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),              //                .error
		.rdata_fifo_src_ready    (wrclk_s1_agent_rdata_fifo_src_ready),            //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (wrclk_s1_agent_rdata_fifo_src_valid),            //                .valid
		.rdata_fifo_src_data     (wrclk_s1_agent_rdata_fifo_src_data),             //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) wrclk_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (wrclk_s1_agent_rf_source_data),                  //        in.data
		.in_valid          (wrclk_s1_agent_rf_source_valid),                 //          .valid
		.in_ready          (wrclk_s1_agent_rf_source_ready),                 //          .ready
		.in_startofpacket  (wrclk_s1_agent_rf_source_startofpacket),         //          .startofpacket
		.in_endofpacket    (wrclk_s1_agent_rf_source_endofpacket),           //          .endofpacket
		.out_data          (wrclk_s1_agent_rsp_fifo_out_data),               //       out.data
		.out_valid         (wrclk_s1_agent_rsp_fifo_out_valid),              //          .valid
		.out_ready         (wrclk_s1_agent_rsp_fifo_out_ready),              //          .ready
		.out_startofpacket (wrclk_s1_agent_rsp_fifo_out_startofpacket),      //          .startofpacket
		.out_endofpacket   (wrclk_s1_agent_rsp_fifo_out_endofpacket),        //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	Arquitetura_mm_interconnect_0_router_002 router_008 (
		.sink_ready         (wrclk_s1_agent_rp_ready),                        //      sink.ready
		.sink_valid         (wrclk_s1_agent_rp_valid),                        //          .valid
		.sink_data          (wrclk_s1_agent_rp_data),                         //          .data
		.sink_startofpacket (wrclk_s1_agent_rp_startofpacket),                //          .startofpacket
		.sink_endofpacket   (wrclk_s1_agent_rp_endofpacket),                  //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Arquitetura_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (wrclk_s1_agent_rdata_fifo_src_data),             //     in_0.data
		.in_0_valid     (wrclk_s1_agent_rdata_fifo_src_valid),            //         .valid
		.in_0_ready     (wrclk_s1_agent_rdata_fifo_src_ready),            //         .ready
